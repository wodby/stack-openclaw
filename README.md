# OpenClaw application stack for Kubernetes on Wodby

Deploy OpenClaw applications on Kubernetes with Wodby.

This repository defines the Wodby stack manifests and default service
composition for OpenClaw.
...
- [OpenClaw service](https://github.com/wodby/service-openclaw)
- [Tailscale service](https://github.com/wodby/service-tailscale)

## What's included

| Component / service | Default configuration |
| --- | --- |
| OpenClaw<br>`openclaw` | required; enabled by default |
| Tailscale<br>`tailscale` | required; enabled by default; links: `serve` → `openclaw` |
