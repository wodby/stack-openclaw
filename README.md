# OpenClaw stack for Wodby

Deploy OpenClaw on Kubernetes with Wodby. This repository contains the stack
manifests used by the public OpenClaw stack in the Wodby catalog.

- [OpenClaw stack in the Wodby catalog](https://wodby.com/stacks/openclaw)
